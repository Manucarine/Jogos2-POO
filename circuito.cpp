...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	/* Os comandos de if e else foram utilizados para que o circuito possa fazer a interpretação 
	de quando o usuario digitor a sequencia correta, o circuito ascender, ou não ascender. 
	
	Por exemplo:
	
		caso o programa gere (aleatoriamente):
			num1 = 3
			num2 = 3
			num3 = 2
			num4 = 3
		E o nosso usuário digitar exatamente esses numeros:
			3 3 2 3
